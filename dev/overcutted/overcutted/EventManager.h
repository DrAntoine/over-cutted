...
//====================================================================================
// Début de mise en place du matériel nécessaire à l'objet EventManager
...
struct Binding {
	...
	Events m_events;
	std::string m_name;
	int c; //compte le nombre d'évenement qui sont survenu, sert à déterminer si on à traiter tout les evenements.
...
// Fin de mise en place du matériel nécessaire à l'objet EventManager
//====================================================================================
