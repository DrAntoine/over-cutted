...
sf::Vector2i Snake::GetPosition() { return (!m_snakeBody.empty() ? m_snakeBody.front().position : sf::Vector2i(1, 1)); }
...
void Snake::Cut(int l_segments) // Method for cutting snake
{
